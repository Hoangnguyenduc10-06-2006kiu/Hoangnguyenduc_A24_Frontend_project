...
let log_out = document.querySelector("#log-out-button-statistics");
let tbodyStatistics = document.querySelector("#tbodyStatistics");
let filterClass = document.querySelector("#filterClass").value;
let filterEmail = document.querySelector("#filterEmail").value;
let filterDayTraning = document.querySelector("#filterDayTraning").value;
...
function renderListContentFilter() {
  ...
  let listContentFilterslice = localBooking.slice(star, end);
  let listFilter = listContentFilterslice.map((user, index) => {
    return ` <tr>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  let converArraytoString = listFilter.join("");
  tbodyStatistics.innerHTML = converArraytoString;
}
